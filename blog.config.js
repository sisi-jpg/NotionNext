...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Sissi', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '小白程序员', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-fsof.vercel.app/', // 网站地址
